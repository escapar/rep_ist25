...
def evaluate_ae_rq3(lang, smell, mode, ratio, layer, encoding, ep, threshold_val):
    ...
    for i in range(layer):
        prev_layer = Dense(int(encoding / pow(2, i)), activation="relu",
    ...
    c_res_file = os.path.join(OUT_FOLDER, f"rq3_clean_ae_{smell}.csv")
...
if __name__ == "__main__":
    ...
    params = {
        "ComplexMethod": (1, 32, 20, 325000),
        "ComplexConditional": (1, 16, 20, 328000),
        "FeatureEnvy": (2, 16, 20, 325000),
        "MultifacetedAbstraction": (1, 16, 20, 328000)
    }
